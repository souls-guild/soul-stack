...
- **Names:** neither in the new code nor in the comments/logs/doc there should be off-dictionary `master`, `minion`, `state`, `grain`, `pillar`. Soul Stack dictionary only. New names should be in `docs/naming-rules.md`.
