...
# `git ls-remote --tags https://github.com/redis/redis` (2026-06-26): серий 6.4/8.8 в
# смысле «новый набор директив» нет — реальные серии 6.2/7.0/7.2/7.4/8.0/8.2 (8.8 —
# существующая патч-серия 8.x, в сервис пока не берём).
DEFAULT_TAGS=(6.2.22 7.0.15 7.2.14 7.4.9 8.0.6 8.2.7)
