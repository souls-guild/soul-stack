module github.com/souls-guild/soul-stack/tests/e2e
...
// FromSoul/FromKeeper/KeeperClient для soul-stub-а. Это единственный
// проектный модуль, который harness импортирует напрямую (без internal/-
// зависимостей).
