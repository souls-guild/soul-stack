...
- [`docs/architecture.md`](../architecture.md) — the layers above and below Soul:
  - [Soul lifecycle and the soul registry](../architecture.md) — registries and statuses.
  - [Soul connection: priority and failback](../architecture.md) — the algorithm specification.
  - [Push mode (`keeper.push`)](../architecture.md) — the second transport.
  - [Module model](../architecture.md) — what Soul executes.
  - [Delivering the SoulSeed token to the host](../architecture.md) — ways to deliver the token.
