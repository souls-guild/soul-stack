...
Full documentation - [`soul-mod-official-docker-container/README.md`](https://github.com/co-cy/soul-stack-plugins/blob/main/soul-mod-official-docker-container/README.md) in the companion repo.
