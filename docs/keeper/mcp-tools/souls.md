...
| `selector.incarnation` | `string` (incarnation-name) | optional | **Member** hosts of this incarnation (matched via the `incarnation_membership` relation, not a coven — `incarnation.id` is no longer a Coven, [ADR-008 amendment 2026-07-17](../../adr/0008-coven-stable-tags.md#amendment-2026-07-17-nim-124-incarnationname-is-not-a-coven--membership-is-a-first-class-relation)). |
