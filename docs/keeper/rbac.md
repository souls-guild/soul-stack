...
| `incarnation=` | Permission is limited to a specific instance. | `incarnation.name` of the target instance. **This is the scope for the incarnation's own name** — a role that previously used `coven=<incarnation-name>` migrates here ([ADR-008 amendment 2026-07-17](../adr/0008-coven-stable-tags.md#amendment-2026-07-17-nim-124-incarnationname-is-not-a-coven--membership-is-a-first-class-relation)). |
