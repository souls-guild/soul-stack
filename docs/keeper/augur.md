...
| `omen` | `TEXT REFERENCES omens(id) ON DELETE CASCADE` | Omen, which grant refers to. **CASCADE**: deleting an Omen removes all of its Rites (see §9 fork). |
...
| `omen_name` | string | Omen's name (`omens.id`). |
