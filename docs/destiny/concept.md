...
| **Module** | `core.pkg.installed`, `wb.haproxy.reloaded`, … | Implementation of one "verb" (install the package, start the service, render the file). See [architecture.md → "Module model"](../architecture.md). |
