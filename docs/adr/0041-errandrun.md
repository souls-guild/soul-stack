...
4. **Module whitelist — the same as [ADR-033](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario)** (`core.cmd.shell` / `core.exec.run` /
...
8. **Async by default.** Sync escalation (parity [ADR-033 §3](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario)) for a single-Errand
...
12. **Cancel** — `DELETE /v1/errand-runs/{id}` cancels all `running` Errands
    via the existing `CancelErrand` ([ADR-033 amendment 2026-05-27](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario), slice E5).
...
| `Errand` | unit-of-work (unchanged, [ADR-033](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario)) |
...
- ErrandRun does NOT mutate incarnation.state (inherits the [ADR-033](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario) invariant).
...
- Whitelist enforced on the Soul side per-Errand (defense-in-depth [ADR-033](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario)).
...
- ErrandRun for keeper-side core (parallel to [ADR-033](0033-errand.md#adr-033-errand--pull-ad-hoc-exec-outside-a-scenario) "Deferred").
