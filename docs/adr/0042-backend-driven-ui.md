...
- `GET /v1/event-types` — event-type catalog for Tiding subscription (source [`herald/eventtypes.go`](https://github.com/souls-guild/soul-stack/blob/main/keeper/internal/herald/eventtypes.go), ADR-052).
