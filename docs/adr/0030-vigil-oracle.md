...
- **ADR reconciliation.**
  ...
  - [ADR-016(d)](0016-parity-license.md#adr-016-parity-strategy-with-saltstackansible-and-the-soul-stack-license) — the event-driven backlog is closed; community checks — via the `soul_beacon` plugin-kind (the 4th kind of plugin infrastructure, S5), the implementation is under Sigil integrity ([ADR-026](0026-sigil.md#adr-026-sigil--plugin-integrity-keeper-signed-digest-index)).
- **Consequences.**
