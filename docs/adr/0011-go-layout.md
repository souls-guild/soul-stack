...
cloud-mirror schema fixture under `testdata/` the epic expected to travel with it did not,
because that ticket had already deleted it along with the mirror it policed.
