...
- **[ADR-016](../adr/0016-parity-license.md)** — parity strategy and license: namespace scheme (`core` / `official` / third parties), open-core, prohibition of wrappers over Ansible.
