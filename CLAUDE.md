...
The naming convention ([docs/naming-rules.md](docs/naming-rules.md)) is required everywhere: in the names of packages, types, files, endpoints, CLI flags, metrics, labels, log messages and user documentation. Use **Keeper**, **Souls**, **Destiny**, **Soulprint**, **Essence** (see table in the "Intent" section). The primary terms are ours; use them consistently across code and docs.
...
| Essence | Soul parameters/meanings |
