...
--
-- ADR-043 amendment (2026-06-01) -> S-W3/S-W4: batch strategies for
...
-- of migration 064).
--
--   * batch_percent - batch size as a % of the resolved scope,
--     MUTUALLY EXCLUSIVE with batch_size. Stored for audit/UI; the handler,
