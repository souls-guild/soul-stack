...
type HeraldCreateRequest struct {
	...
	Type      string         `json:"type" required:"true" enum:"webhook" doc:"тип канала (closed-enum, webhook в MVP); значение вне enum → 422"`
...
type HeraldUpdateRequest struct {
	Type      string         `json:"type" required:"true" enum:"webhook" doc:"тип канала (closed-enum, webhook в MVP)"`
