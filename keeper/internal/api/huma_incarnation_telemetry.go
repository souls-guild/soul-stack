...
// GET /v1/incarnations/{id}/telemetry — aggregate host-vitals across incarnation hosts
...
// incarnationTelemetryInput — huma-input GET /v1/incarnations/{id}/telemetry.
...
// incarnationTelemetryOperation — metadata for GET /v1/incarnations/{id}/telemetry.
...
// registerHumaIncarnationTelemetry mounts GET /v1/incarnations/{id}/telemetry
...
func registerHumaIncarnationTelemetry(humaAPI huma.API, telemetryH *handlers.TelemetryHandler) {
	...
	huma.Register(humaAPI, incarnationTelemetryOperation(), func(ctx context.Context, in *incarnationTelemetryInput) (*incarnationTelemetryOutput, error) {
		reply, err := telemetryH.AggregateByIncarnation(ctx, claimsOrNil(ctx), in.ID)
		if err != nil {
