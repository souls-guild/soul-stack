...
var pathAllowlist = map[route]string{
	...
	{method: http.MethodGet, path: "/v1/push-providers/{id}"}:       "S7-2 push-provider get: route wired ONLY when non-nil pushProviderH",
	{method: http.MethodPut, path: "/v1/push-providers/{id}"}:       "S7-2 push-provider update: route wired ONLY when non-nil pushProviderH",
	{method: http.MethodDelete, path: "/v1/push-providers/{id}"}:    "S7-2 push-provider delete: route wired ONLY when non-nil pushProviderH",
	{method: http.MethodPut, path: "/v1/push-providers/{id}/label"}: "[ADR-0085] push-provider caption: route wired ONLY when non-nil pushProviderH",
	...
	{method: http.MethodPost, path: "/v1/incarnations/{id}/choirs"}:                        "ADR-044 Choir create: route wired ONLY when non-nil choirH",
	{method: http.MethodGet, path: "/v1/incarnations/{id}/choirs"}:                         "ADR-044 Choir list: route wired ONLY when non-nil choirH",
	{method: http.MethodDelete, path: "/v1/incarnations/{id}/choirs/{choir}"}:              "ADR-044 Choir delete: route wired ONLY when non-nil choirH",
	{method: http.MethodPost, path: "/v1/incarnations/{id}/choirs/{choir}/voices"}:         "ADR-044 Voice add: route wired ONLY when non-nil choirH",
	{method: http.MethodGet, path: "/v1/incarnations/{id}/choirs/{choir}/voices"}:          "ADR-044 Voice list: route wired ONLY when non-nil choirH",
	{method: http.MethodDelete, path: "/v1/incarnations/{id}/choirs/{choir}/voices/{sid}"}: "ADR-044 Voice remove: route wired ONLY when non-nil choirH",
	...
	{method: http.MethodGet, path: "/v1/heralds/{id}"}:       "ADR-052 Herald get: route wired ONLY when non-nil heraldH",
	{method: http.MethodPut, path: "/v1/heralds/{id}"}:       "ADR-052 Herald update: route wired ONLY when non-nil heraldH",
	{method: http.MethodDelete, path: "/v1/heralds/{id}"}:    "ADR-052 Herald delete: route wired ONLY when non-nil heraldH",
	{method: http.MethodPut, path: "/v1/heralds/{id}/label"}: "[ADR-0085] Herald caption: route wired ONLY when non-nil heraldH",
	...
	{method: http.MethodGet, path: "/v1/tidings/{id}"}:       "ADR-052 Tiding get: route wired ONLY when non-nil heraldH",
	{method: http.MethodPut, path: "/v1/tidings/{id}"}:       "ADR-052 Tiding update: route wired ONLY when non-nil heraldH",
	{method: http.MethodDelete, path: "/v1/tidings/{id}"}:    "ADR-052 Tiding delete: route wired ONLY when non-nil heraldH",
	{method: http.MethodPut, path: "/v1/tidings/{id}/label"}: "[ADR-0085] Tiding caption: route wired ONLY when non-nil heraldH",
...
func stubServiceHandler(t *testing.T) *handlers.ServiceHandler {
	...
	return handlers.NewServiceHandler(svc, nil, nil, nil, nil, nil, nil, nil, "", nil)
}
