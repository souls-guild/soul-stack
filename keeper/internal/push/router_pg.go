...
// a host's coven labels for the Level 2 resolve. Kept isolated from
...
// SelectCovens reads the host's own `souls.coven[]` — the labels an operator
// attached to it, and no others (NIM-281).
