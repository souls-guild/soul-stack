...
func TestSendApply_HappyPath(t *testing.T) {
	...
	rr, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, req, nil)
	if err != nil {
...
func TestSendApply_FailedRunResult_NoTransportError(t *testing.T) {
	...
	got, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-2"}, nil)
	if err != nil {
...
func TestSendApply_AuthorizeDeny(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-3"}, nil)
	if err == nil {
...
func TestSendApply_ConnectFail(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-4"}, nil)
	if err == nil {
...
func TestSendApply_RejectsNonSSHTransport(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-5"}, nil)
	if err == nil {
...
func TestSendApply_NoRunResultIsTransportError(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-6"}, nil)
	if err == nil {
...
func TestSendApply_SignError(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-7"}, nil)
...
func TestSendApply_VaultEphemeralMode(t *testing.T) {
	...
	rr, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-vault-1"}, nil)
	if err != nil {
...
func TestSendApply_VaultEphemeralMode_RejectsEmptyCert(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-vault-2"}, nil)
	if err == nil {
...
func TestSendApply_ProxyJumpPropagatedToDial(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-pj-1"}, nil)
	if err != nil {
		t.Fatalf("SendApply: %v", err)
	}
...
func TestSendApply_ProxyJumpEmpty_DirectFlow(t *testing.T) {
	...
	_, err := disp.SendApply(context.Background(), "host-1.example.com", Route{Provider: testProviderName}, &keeperv1.ApplyRequest{ApplyId: "ap-pj-empty"}, nil)
	if err != nil {
		t.Fatalf("SendApply: %v", err)
	}
