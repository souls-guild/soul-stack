...
WEB_PORT=5174
# soul-stack-web - sibling of the soul-stack ROOT (not the worktree). REPO_ROOT here = worktree,
# so we take the main repo (../../.. from dev/upgrade-demo -> worktree; the main repo is
# 3 levels above .claude/worktrees/<wt>). Explicit default based on the known layout.
