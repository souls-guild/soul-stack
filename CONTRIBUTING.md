...
Contributor License Agreement пока **не заведён**. По [ADR-016](docs/adr/0016-parity-license.md) (Amendment 2026-07-09, fair-code/BSL) CLA заводится **до первого внешнего contributor-а**: под fair-code он нужен не «на всякий случай», а чтобы держать право на Additional Use Grant, Change License и будущие правки лицензии. Поскольку на закрытой бете внешние code-контрибуции не принимаются, CLA появится одновременно с открытием контрибуции — PR с кодом без подписанного CLA приниматься не будут.
